...
**Email:** [yashrajsharan2006@gmail.com](mailto:yashrajsharan2006@gmail.com) | **Phone:** +91 94714 44635  
**LinkedIn:** [linkedin.com/in/yashraj10](https://linkedin.com/in/yashraj10) | **GitHub:** [github.com/omen18](https://github.com/omen18) | **Portfolio:** [yash-dev-seven.vercel.app](https://yash-dev-seven.vercel.app)  
**Location:** Chennai, Tamil Nadu, India  
**Role:** Full Stack Developer · AI & Machine Learning Undergraduate at SRMIST
...
## Technical Skills
- **Languages:** TypeScript, JavaScript (ES6+), Python, Java, SQL, Rust, Swift
- **Frontend:** React 18/19, Next.js, Vite, HTML5, CSS3, Tailwind CSS, Three.js, GSAP, Responsive UI, REST/API integration
- **Backend:** Node.js, Express.js, FastAPI, REST APIs, WebSockets, JWT & bcrypt auth, concurrency control, transactional integrity
- **Databases:** MySQL (schema design, indexing, atomic transactions), MongoDB
- **AI/ML:** PyTorch, TensorFlow, ONNX Runtime, NumPy, Pandas, Generative AI / LLM integration
- **Tools:** Git, GitHub, Postman, Vercel, Jupyter Notebook, Google Colab, Xcode
